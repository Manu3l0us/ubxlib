...
class UbxKeyId(object):
    ...
    CFG_SFIMU_AUTO_MNTALG_ENA = 0x10060027

    CFG_SFIMU_IMU_MNTALG_YAW = 0x4006002d
    CFG_SFIMU_IMU_MNTALG_PITCH = 0x3006002e
    CFG_SFIMU_IMU_MNTALG_ROLL = 0x3006002f

    CFG_SFIMU_IMU2ANT_LA_X = 0x30060020
    CFG_SFIMU_IMU2ANT_LA_Y = 0x30060021
    CFG_SFIMU_IMU2ANT_LA_Z = 0x30060022

    CFG_SFODO_DIS_AUTODIRPINPOL = 0x10070005
    CFG_SFODO_USE_WT_PIN = 0x1007000f
    CFG_SFODO_DIR_PINPOL = 0x10070010

    CFG_SFODO_IMU2VRP_LA_X = 0x30070012
    CFG_SFODO_IMU2VRP_LA_Y = 0x30070013
    CFG_SFODO_IMU2VRP_LA_Z = 0x30070014
    ...
    KEY_INFO = {
        ...
        CFG_TP_LEN_TP1: KeyInfo("CFG-TP-LEN_TP1"),
        ...
        CFG_SFIMU_IMU_MNTALG_YAW: KeyInfo("CFG-SFIMU_IMU_MNTALG_YAW", False),
        CFG_SFIMU_IMU_MNTALG_PITCH: KeyInfo("CFG-SFIMU_IMU_MNTALG_PITCH", True),
        CFG_SFIMU_IMU_MNTALG_ROLL: KeyInfo("CFG-SFIMU_IMU_MNTALG_ROLL", True),

        CFG_SFIMU_IMU2ANT_LA_X: KeyInfo("CFG-SFIMU_IMU2ANT_LA_X", True),
        CFG_SFIMU_IMU2ANT_LA_Y: KeyInfo("CFG-SFIMU_IMU2ANT_LA_Y", True),
        CFG_SFIMU_IMU2ANT_LA_Z: KeyInfo("CFG-SFIMU_IMU2ANT_LA_Z", True),

        CFG_SFODO_IMU2VRP_LA_X: KeyInfo("CFG-SFODO_IMU2VRP_LA_X", True),
        CFG_SFODO_IMU2VRP_LA_Y: KeyInfo("CFG-SFODO_IMU2VRP_LA_Y", True),
        CFG_SFODO_IMU2VRP_LA_Z: KeyInfo("CFG-SFODO_IMU2VRP_LA_Z", True),

        CFG_SFODO_USE_WT_PIN: KeyInfo("CFG-SFODO_USE_WT_PIN"),
        CFG_SFODO_DIS_AUTODIRPINPOL: KeyInfo("CFG-SFODO_DIS_AUTODIRPINPOL"),
        CFG_SFODO_DIR_PINPOL: KeyInfo("CFG-SFODO_DIR_PINPOL")
    }
